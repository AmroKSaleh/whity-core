...
final class CorePermissionDescriptions
{
    ...
    public static function all(): array
    {
        ...
        CorePermissions::STATS_READ                   => 'Read the admin dashboard aggregates — counts, role breakdown and signup trend for this tenant',
        ...
        CorePermissions::LICENSING_VIEW               => "View this tenant's licensed devices and their activation state",
        CorePermissions::LICENSING_ISSUE              => 'Issue activation codes — the commercial act of selling a licence',
        CorePermissions::LICENSING_MANAGE             => "Provision serials, revoke codes and retire this tenant's devices",
