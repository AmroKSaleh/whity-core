...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'admin',
      testMatch: /(navigation|roles|users|ous-tenants|ous-hub|stats|settings-2fa|profile|website-settings|branding|global-settings|sso|email-settings|document-designer)\.spec\.ts/,
      dependencies: ['setup'],
