 ...
 * a hand-maintained twin. Every existing `@/components/documents/editor-top-bar` import
 * keeps working unchanged.
 */
export { EditorTopBar, ShortcutsDialog, useModLabel } from '@amroksaleh/features/document-designer';
