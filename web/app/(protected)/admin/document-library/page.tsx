 ...
 * can actually COMPUTE. When the routing-derived folders are registered they
 * appear here with no change to this file; a hardcoded rail would have needed
 * editing, and would have shipped empty folders in the meantime. An empty
 * "Awaiting me" would state "nothing awaits you" — false, unfalsifiable from the
 * outside, and indistinguishable from having nothing to do.
 *
